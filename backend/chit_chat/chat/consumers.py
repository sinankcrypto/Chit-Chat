    ...
    async def receive(self, text_data):
        ...
        await self.channel_layer.group_send(
            self.room_group_name,
            {
                ...
                "file_url": saved_message.attachment.file_url if saved_message.attachment else None,
                "file_type": saved_message.attachment.file_type if saved_message.attachment else None,
                "file_name": saved_message.attachment.file_name if saved_message.attachment else None,
                "sender": self.user.username,
